...
description: "A bioengineer on why AI still can't reason over time, what a soccer injury taught him about building from nothing, and where humans still matter most — brain-computer interfaces, biosensors, and accessibility tech."
metaTitle: "Why AI Can't Reason Over Time | Michael Iwashima on BCIs & Accessibility | Still Human"
metaDescription: "A bioengineer on why AI still can't reason over time, what a soccer injury taught him about building from nothing, and where humans still matter most."
primaryKeyword: "brain-computer interfaces for accessibility"
secondaryKeywords: "AI limitations reasoning over time, AI in agriculture, AI tutor education model, mold detection biosensor, frugal science, AI Collaborate Santa Clara, Purdue Verma Lab, AI healthcare accessibility, student founder AI club, execution culture"
publishDate: ""
...
- `[00:00:00]` — Michael Iwashima intro: bioengineering, BCI work, and the path through injury
- `[00:03:00]` — The soccer injury that ended one path and opened another
- `[00:07:30]` — Brain-computer interfaces: Space Invaders, paralysis, and accessibility
- `[00:12:00]` — Why AI can't reason over time — the limit Michael keeps running into
- `[00:16:30]` — Frugal science: 3D-printable biosensors and AI in agriculture
- `[00:20:00]` — Mold detection: building a startup around a problem most people can't see
- `[00:23:30]` — AI Collaborate at Santa Clara: from near-shutdown to 200 members
- `[00:26:00]` — A "1 of 1" education model: AI for knowledge, humans for curiosity
- `[00:28:30]` — Why community building is the most underrated skill in an AI-saturated world
