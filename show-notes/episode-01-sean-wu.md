...
description: "Sean Wu raised over $2M for Synphony — a robotics startup tackling the sim-to-real gap — while finishing his junior year at Santa Clara. On execution culture, the wrestling lesson behind founder loneliness, and why most students never ship."
metaTitle: "Execution Culture: Sean Wu on Raising $2M for Robotics & the Sim-to-Real Gap | Still Human"
metaDescription: "A Santa Clara junior on raising $2M for robotics, why most students never ship, and the wrestling lesson behind execution culture."
primaryKeyword: "execution culture"
secondaryKeywords: "student founder, Sean Wu Synphony, sim-to-real gap robotics, NVIDIA hackathon, raising venture capital as a student, RAG pipelines, world models, AI Collaborate Santa Clara, cold outreach student, wrestling mindset founder"
publishDate: ""
...
- `[00:00:00]` — Sean Wu intro: Santa Clara junior, Synphony, and the wrestling backstory
- `[00:04:00]` — Why "execution culture" matters more than ideas — and what most students miss
- `[00:09:30]` — "Just beg, bro": cold outreach as a student and why it works
- `[00:15:00]` — Raising $2M while finishing a degree: the access advantage of being 20
- `[00:21:30]` — Inside the NVIDIA hackathon win that became Synphony
- `[00:27:00]` — The sim-to-real gap: why robotics simulations are 90% accurate and why that's not enough
- `[00:32:00]` — Building RAG pipelines for Citibank — when failure isn't an option
- `[00:36:30]` — Pivoting away from a $10K/month business to start something bigger
- `[00:41:00]` — Wrestling and founder loneliness: comfortable being uncomfortable
- `[00:44:00]` — Knowing when to pivot vs. push through
- `[00:45:30]` — Where to find Sean and closing
...
- Watch the episode: [youtube.com/watch?v=jq3PUmDQivk](https://www.youtube.com/watch?v=jq3PUmDQivk)
