---
slug: "neural-networks-from-scratch-c-william-norden-neuromorphic-computing"
number: "08"
title: "William Norden: Building Neural Networks from Scratch in C and What Most AI Engineers Skip"
guest: "William Norden"
duration: "52 min"
youtubeId: "qlTFxDjGnmk"
description: "A Still Human conversation with William Norden — Research Engineer at Santa Clara University, neuromorphic computing researcher, and the rare builder who writes neural networks in C from scratch. We get into the intelligence augmentation argument, the high-dimensional tapestry of global problems, and why Russian piano pedagogy and USTA tennis show up in his backpropagation."
metaTitle: "Building Neural Networks from Scratch in C: What Most AI Engineers Skip — Still Human Ep. 08"
metaDescription: "A Still Human conversation with William Norden — research engineer, neuromorphic computing researcher, and the rare builder who writes neural networks in C from scratch."
primaryKeyword: "neural networks from scratch in C"
secondaryKeywords: "neuromorphic computing, spiking neural networks, intelligence augmentation, edge AI, MNIST.c, AlphaChip DeepRune, William Norden Santa Clara, AI as cognitive prosthetic"
publishDate: ""
...
Listen to the full conversation on [Spotify](https://open.spotify.com/episode/2dfdMSUOXFocn3XFt4wwA2), [Apple Podcasts](https://podcasts.apple.com/us/podcast/still-human/id1795315498), or [YouTube](https://www.youtube.com/watch?v=qlTFxDjGnmk). Or read the full transcript on [Substack](https://substack.com/@perkin0909).

---

## Connect With William Norden

- Watch the episode: [youtube.com/watch?v=qlTFxDjGnmk](https://www.youtube.com/watch?v=qlTFxDjGnmk)

---

## Follow Still Human Podcast

Still Human is a biweekly podcast by [Oshen Studio](https://oshenstudio.com), hosted by Perkin — exploring what it means to stay human in the age of AI. Real conversations with builders, creators, founders, and thinkers doing it in real life. New episodes every two weeks on YouTube, Spotify, Substack, and LinkedIn.
